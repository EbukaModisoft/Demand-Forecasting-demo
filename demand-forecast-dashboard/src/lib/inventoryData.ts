...
export const AT_RISK_ITEMS: Record<BusinessType, AtRiskItem[]> = {
  ...
  grocery: [
    { name: 'Whole Milk Gallon', department: 'Dairy', onHand: 8, forecastNeed: 60, daysLeft: 0.3, risk: 'critical', reason: 'Sunday demand — families stocking up', fix: 'Order 3 cases ASAP', fixAction: 'order' },
    { name: 'Bananas', department: 'Produce', onHand: 15, forecastNeed: 80, daysLeft: 0.4, risk: 'critical', reason: '#1 produce item, almost out', fix: 'Emergency produce order', fixAction: 'order' },
    { name: 'Large Eggs 12ct', department: 'Dairy', onHand: 12, forecastNeed: 55, daysLeft: 0.4, risk: 'critical', reason: 'Breakfast staple — will miss morning shoppers', fix: 'Order from backup supplier', fixAction: 'order' },
    ...
    { name: 'Strawberries', department: 'Produce', onHand: 8, forecastNeed: 22, daysLeft: 0.7, risk: 'critical', reason: 'Expiring in 2 days + high demand', fix: 'Discount now, order fresh batch', fixAction: 'discount' },
  ...
  liquor: [
    { name: 'Modelo 12pk', department: 'Beer', onHand: 5, forecastNeed: 35, daysLeft: 0.3, risk: 'critical', reason: 'Weekend coming — #1 beer seller', fix: 'Order 5 cases now', fixAction: 'order' },
    { name: 'Hennessy VS', department: 'Spirits', onHand: 3, forecastNeed: 12, daysLeft: 0.5, risk: 'critical', reason: 'High-margin item almost out', fix: 'Emergency order', fixAction: 'order' },
    { name: 'White Claw 12pk', department: 'Seltzer', onHand: 8, forecastNeed: 25, daysLeft: 0.6, risk: 'critical', reason: 'Summer demand + low stock', fix: 'Order 3 cases', fixAction: 'order' },
  ...
  restaurant: [
    { name: 'Salmon Fillet', department: 'Protein', onHand: 5, forecastNeed: 25, daysLeft: 0.4, risk: 'critical', reason: 'Dinner feature item — will 86 by 7pm', fix: 'Emergency order from fish supplier', fixAction: 'order' },
    { name: 'Cheese Slices', department: 'Dairy', onHand: 10, forecastNeed: 70, daysLeft: 0.3, risk: 'critical', reason: 'Used in burgers, sandwiches, breakfast — runs out fast', fix: 'Order 2 cases', fixAction: 'order' },
    { name: 'Mixed Greens', department: 'Produce', onHand: 8, forecastNeed: 45, daysLeft: 0.4, risk: 'critical', reason: 'Salads are 30% of lunch orders', fix: 'Emergency produce run', fixAction: 'order' },
    { name: 'Chicken Wings', department: 'Protein', onHand: 12, forecastNeed: 50, daysLeft: 0.5, risk: 'critical', reason: 'Game night special tomorrow', fix: 'Double the wing order', fixAction: 'order' },
...
export const INVENTORY_ITEMS: Record<BusinessType, InventoryItem[]> = {
  admin: [
    { id: 'a-1', name: 'Coca-Cola 20oz', department: 'Beverages', onHand: 280, forecastNeed: 150, price: 2.49, cost: 0.89, coverageStatus: 'covered', reorderPoint: 50, parLevel: 300, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Coca-Cola Dist.', caseSize: 24, upc: '049000042566' },
    ...
    { id: 'a-5', name: 'Red Bull 8.4oz', department: 'Beverages', onHand: 96, forecastNeed: 48, price: 3.49, cost: 1.85, coverageStatus: 'covered', reorderPoint: 24, parLevel: 120, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Red Bull Dist.', caseSize: 24, upc: '611269991000' },
    ...
    { id: 'a-7', name: 'Gatorade 20oz', department: 'Beverages', onHand: 144, forecastNeed: 70, price: 2.29, cost: 0.92, coverageStatus: 'covered', reorderPoint: 36, parLevel: 180, lastCountDate: '2025-10-04', daysOfSupply: 4, vendor: 'PepsiCo', caseSize: 24, upc: '052000328769' },
    ...
    { id: 'a-9', name: 'Monster Energy 16oz', department: 'Beverages', onHand: 72, forecastNeed: 40, price: 3.49, cost: 1.75, coverageStatus: 'covered', reorderPoint: 24, parLevel: 96, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Monster Beverage', caseSize: 24, upc: '070847811169' },
    { id: 'a-10', name: 'Hot Dog Roller', department: 'Foodservice', onHand: 15, forecastNeed: 30, price: 1.99, cost: 0.55, coverageStatus: 'low_stock', reorderPoint: 20, parLevel: 48, lastCountDate: '2025-10-05', daysOfSupply: 1, vendor: 'Sysco', caseSize: 48, upc: '073654005218' },
    ...
    { id: 'a-14', name: 'Coffee Fresh Brew 12oz', department: 'Beverages', onHand: 30, forecastNeed: 50, price: 1.79, cost: 0.25, coverageStatus: 'low_stock', reorderPoint: 20, parLevel: 60, lastCountDate: '2025-10-03', daysOfSupply: 1, vendor: 'Sysco', caseSize: 6 },
  ...
  convenience: [
    { id: 'c-1', name: 'Coca-Cola 20oz', department: 'Beverages', onHand: 280, forecastNeed: 150, price: 2.49, cost: 0.89, coverageStatus: 'covered', reorderPoint: 50, parLevel: 300, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Coca-Cola Dist.', caseSize: 24, upc: '049000042566' },
    ...
    { id: 'c-5', name: 'Red Bull 8.4oz', department: 'Beverages', onHand: 96, forecastNeed: 48, price: 3.49, cost: 1.85, coverageStatus: 'covered', reorderPoint: 24, parLevel: 120, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Red Bull Dist.', caseSize: 24, upc: '611269991000' },
    ...
    { id: 'c-9', name: 'Monster Energy 16oz', department: 'Beverages', onHand: 72, forecastNeed: 40, price: 3.49, cost: 1.75, coverageStatus: 'covered', reorderPoint: 24, parLevel: 96, lastCountDate: '2025-10-05', daysOfSupply: 4, vendor: 'Monster Beverage', caseSize: 24, upc: '070847811169' },
    { id: 'c-10', name: 'Hot Dog Roller', department: 'Foodservice', onHand: 15, forecastNeed: 30, price: 1.99, cost: 0.55, coverageStatus: 'low_stock', reorderPoint: 20, parLevel: 48, lastCountDate: '2025-10-05', daysOfSupply: 1, vendor: 'Sysco', caseSize: 48, upc: '073654005218' },
  ...
  grocery: [
    { id: 'g-1', name: 'Whole Milk Gallon', department: 'Dairy', onHand: 60, forecastNeed: 40, price: 4.29, cost: 2.85, coverageStatus: 'covered', reorderPoint: 20, parLevel: 80, lastCountDate: '2025-10-05', daysOfSupply: 3, vendor: 'Dean Foods', caseSize: 4, upc: '041900065201' },
    ...
    { id: 'g-4', name: 'Chicken Breast (lb)', department: 'Meat', onHand: 50, forecastNeed: 45, price: 4.99, cost: 2.80, coverageStatus: 'low_stock', reorderPoint: 25, parLevel: 80, lastCountDate: '2025-10-04', daysOfSupply: 2, vendor: 'Tyson', caseSize: 10, upc: '023700007445' },
    ...
    { id: 'g-15', name: 'Avocado Hass (each)', department: 'Produce', onHand: 60, forecastNeed: 40, price: 1.29, cost: 0.65, coverageStatus: 'covered', reorderPoint: 20, parLevel: 80, lastCountDate: '2025-10-05', daysOfSupply: 3, vendor: 'Local Produce', caseSize: 48 },
    ...
    { id: 'g-18', name: 'Strawberries 1lb', department: 'Produce', onHand: 22, forecastNeed: 25, price: 3.99, cost: 2.00, coverageStatus: 'low_stock', reorderPoint: 12, parLevel: 36, lastCountDate: '2025-10-05', daysOfSupply: 2, vendor: 'Driscoll', caseSize: 8 },
    ...
    { id: 'g-23', name: 'Rotisserie Chicken', department: 'Deli', onHand: 8, forecastNeed: 12, price: 7.99, cost: 4.50, coverageStatus: 'low_stock', reorderPoint: 6, parLevel: 16, lastCountDate: '2025-10-05', daysOfSupply: 1, vendor: 'In-store', caseSize: 1 },
  ...
  liquor: [
    ...
    { id: 'l-3', name: 'Modelo Especial 12pk', department: 'Beer', onHand: 80, forecastNeed: 50, price: 16.99, cost: 10.80, coverageStatus: 'covered', reorderPoint: 20, parLevel: 100, lastCountDate: '2025-10-04', daysOfSupply: 3, vendor: 'Constellation', caseSize: 2, upc: '018172678150' },
    { id: 'l-4', name: 'White Claw Variety 12pk', department: 'Seltzer', onHand: 55, forecastNeed: 40, price: 17.99, cost: 11.50, coverageStatus: 'low_stock', reorderPoint: 25, parLevel: 70, lastCountDate: '2025-10-04', daysOfSupply: 2, vendor: 'Mark Anthony', caseSize: 2, upc: '856054006600' },
    ...
    { id: 'l-8', name: 'Hennessy VS 750ml', department: 'Spirits', onHand: 18, forecastNeed: 12, price: 39.99, cost: 25.00, coverageStatus: 'low_stock', reorderPoint: 8, parLevel: 25, lastCountDate: '2025-10-04', daysOfSupply: 2, vendor: 'Moet Hennessy', caseSize: 12, upc: '081753800406' },
    ...
    { id: 'l-18', name: 'Twisted Tea 12pk', department: 'Beer', onHand: 36, forecastNeed: 24, price: 16.99, cost: 11.00, coverageStatus: 'covered', reorderPoint: 12, parLevel: 48, lastCountDate: '2025-10-05', daysOfSupply: 3, vendor: 'Boston Beer', caseSize: 2 },
    ...
    { id: 'l-22', name: 'High Noon Variety 8pk', department: 'Seltzer', onHand: 42, forecastNeed: 28, price: 19.99, cost: 13.50, coverageStatus: 'covered', reorderPoint: 12, parLevel: 48, lastCountDate: '2025-10-04', daysOfSupply: 3, vendor: 'E&J Gallo', caseSize: 3 },
  ...
  restaurant: [
    { id: 'r-1', name: 'Chicken Breast (case)', department: 'Protein', onHand: 120, forecastNeed: 90, price: 8.99, cost: 4.20, coverageStatus: 'covered', reorderPoint: 40, parLevel: 150, lastCountDate: '2025-10-05', daysOfSupply: 2, vendor: 'Sysco', caseSize: 40, upc: '023700007445' },
    ...
    { id: 'r-3', name: 'Salmon Fillet (case)', department: 'Protein', onHand: 15, forecastNeed: 25, price: 18.99, cost: 12.00, coverageStatus: 'low_stock', reorderPoint: 15, parLevel: 50, lastCountDate: '2025-10-04', daysOfSupply: 1, vendor: 'US Foods', caseSize: 15 },
    ...
    { id: 'r-6', name: 'French Fries 5lb (case)', department: 'Frozen', onHand: 200, forecastNeed: 120, price: 5.99, cost: 2.80, coverageStatus: 'covered', reorderPoint: 50, parLevel: 250, lastCountDate: '2025-10-05', daysOfSupply: 3, vendor: 'Sysco', caseSize: 6 },
    ...
    { id: 'r-15', name: 'Wing Flats & Drums (case)', department: 'Protein', onHand: 60, forecastNeed: 50, price: 7.99, cost: 4.00, coverageStatus: 'low_stock', reorderPoint: 30, parLevel: 80, lastCountDate: '2025-10-05', daysOfSupply: 2, vendor: 'US Foods', caseSize: 40 },
...
export const HEALTH_ACTIONS: InventoryHealthAction[] = [
  { label: 'Reorder Red Bull 12oz', impact: '+4 pts' },
