    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex items-baseline gap-2">
            ...
            {subValue && (
                <span className={`text-[11px] font-bold py-0.5 px-1.5 rounded-md ${subValue.includes('+') ? 'text-modisoft-green bg-modisoft-green/10' : 'text-gray-500 bg-gray-50'}`}>
                    {subValue}
                </span>
            )}
        </div>
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
      <KpiCard 
        ...
        icon={DollarSign} 
        colorClass="text-modisoft-green bg-modisoft-green" 
      ...
      <KpiCard 
        ...
        icon={Tag} 
        colorClass="text-modisoft-turquoise bg-modisoft-turquoise"
      ...
      <KpiCard 
        ...
        subValue="Vol."
        icon={ShoppingBag} 
        colorClass="text-modisoft-blue bg-modisoft-blue"
      ...
      <KpiCard 
        ...
        subValue="Events"
        icon={CloudRain} 
        colorClass="text-modisoft-yellow bg-modisoft-yellow"
      ...
      <KpiCard 
        ...
        icon={Calendar} 
        colorClass="text-modisoft-teal bg-modisoft-teal"
